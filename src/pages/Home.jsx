        ...
        <AnimatePresence>
          {showScrollTop && (
            <motion.button 
              ...
              onClick={scrollToTop}
              className="fixed bottom-8 right-8 z-50 w-12 h-12 flex items-center justify-center rounded-full border border-[var(--color-amode-gold)] bg-[var(--color-amode-black)] text-[var(--color-amode-gold)] hover:bg-[var(--color-amode-gold)] hover:text-white transition-colors duration-300 shadow-lg"
